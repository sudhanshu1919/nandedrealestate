...
import style from "./PropertySearch.module.css";
          ...
          <div className={`col-6 ${style.Headding}`}>
            <div className={`${style.ps_items}`}>
              <label htmlFor="p_range">
                ₹ 1,00000 to 5,00,00,000 ₹ {formData.priceRange} Lakh
              </label>
              <input
                type="range"
                id="p_range"
                ...
                onChange={(e) => {
                  handleRangeChange(e);
                  setPrice(
                    formData.priceRange.toLocaleString("en-IN", {
          ...
          <div className={`col-6 ${style.Headding}`}>
            <div className={`${style.ps_items}`}>
              <label htmlFor="builtUpArea">
                100 to 10,000 sqft.: {formData.builtUpArea} sqft
              </label>
              <input
                type="range"
                id="builtUpArea"
